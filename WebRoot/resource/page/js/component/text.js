Object.assign(design, {
  textHtml: `<div class="group" data-xhtml="text" data-xdata = "{ifWrite: flase, ifShow: true, ifEditor: true}" data-option=""><div class="am-form-group">
      ...
      <input type="text" id="doc-vld-name" placeholder="" class="am-form-field" pattern="" disabled/>
    </div></div>`,
  textData: {
    title: '新输入框',
    id: '100',
  ...
  textLoad (page) {
    ...
    html.attr({'data-xdata': JSON.stringify({ifWrite: page.data.ifWrite, ifShow: page.data.ifShow, ifEditor: page.data.ifEditor}), 'data-option': page.data.option})
